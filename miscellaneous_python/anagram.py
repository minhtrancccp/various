...
from miscellaneous_python.latin_validator import ValidatedStringType, latin_filter
...
@beartype
def _string_to_product(string: ValidatedStringType) -> int:
    return prod(map(_LETTER_TO_PRIME.get, latin_filter(string)))
