...
@beartype
def _valid_decimal(decimal: PositiveInteger) -> bool:
    """
    ...
    largest_valid_number: PositiveInteger = 3_999
    return decimal <= largest_valid_number


@beartype
def _roman_symbols(index: NaturalNumber, digit: str) -> str:
    """
...
def encoder(decimal: Annotated[PositiveInteger, Is[_valid_decimal]]) -> str:
    ...
    index_digit_pair: tuple[NaturalNumber, str]
